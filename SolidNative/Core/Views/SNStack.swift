...
class SNVStack: SolidNativeView {
    ...
    struct SNVStack: View {
        ...
        var body: some View {
            ...
            let alignment = anyToHorizontalAlignment(props.getString(name: "alignment", default: "")) ?? .center
...
class SNHStack: SolidNativeView {
    ...
    struct SNHStack: View {
        ...
        var body: some View {
            ...
            let alignment = anyToVerticalAlignment(props.getString(name: "alignment", default: "")) ?? .center
...
class SNZStack: SolidNativeView {
    ...
    struct SNZStack: View {
        ...
        var body: some View {
            ...
            let alignment = anyToAlignment(props.getString(name: "alignment", default: "")) ?? .center
