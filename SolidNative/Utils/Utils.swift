...
func anyToAlignment(_ value: Any?) -> Alignment? {
    ...
    if s == "center" {
        ...
        return .bottom
    } else if s == "topLeading" {
        return .topLeading
    } else if s == "topTrailing" {
        return .topTrailing
    } else if s == "bottomLeading" {
        return .bottomLeading
    } else if s == "bottomTrailing" {
        return .bottomTrailing
    } else if s == "centerFirstTextBaseline" {
        return .centerFirstTextBaseline
    } else if s == "centerLastTextBaseline" {
        return .centerLastTextBaseline
    } else if s == "leadingFirstTextBaseline" {
        return .leadingFirstTextBaseline
    } else if s == "leadingLastTextBaseline" {
        return .leadingLastTextBaseline
    } else if s == "trailingFirstTextBaseline" {
        return .trailingFirstTextBaseline
    } else if s == "trailingLastTextBaseline" {
...
func anyToVerticalAlignment(_ value: Any?) -> VerticalAlignment? {
    ...
    if s == "top" {
        ...
        return .center
    } else if s == "firstTextBaseline" {
        return .firstTextBaseline
    } else if s == "lastTextBaseline" {
...
func anyToHorizontalAlignment(_ value: Any?) -> HorizontalAlignment? {
    ...
    if s == "leading" {
        ...
        return .trailing
    } else if s == "listRowSeparatorLeading" {
        return .listRowSeparatorLeading
    } else if s == "listRowSeparatorTrailing" {
